...
const Footer = () => {
  ...
  return (
    <footer className="w-full text-white px-10 min-h-[300px] flex flex-col items-center justify-center py-16 bg- border-t-[0.25px] border-neutral-400/30">
      <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-x-8 gap-y-12">
        ...
        <div className="flex flex-col items-center text-xl font-light space-y-3">
          <div className="flex flex-col w-fit">
            <a
              className="hover:text-neutral-300 transition-colors duration-300 w-fit"
              href="/about"
            >
              About Us
            </a>
        ...
        <div className="flex flex-col items-center text-xl font-light space-y-3">
          <div className="flex flex-col w-fit">
            <a
              className="group flex flex-row items-center hover:text-neutral-300 transition-colors duration-300 w-fit"
              href="/email"
              onClick={copyEmail}
            >
              {!copied && (
            ...
            <a
              className="flex flex-row items-center hover:text-neutral-300 transition-colors duration-300 w-fit"
            ...
            <a
              className="group relative flex flex-row items-center hover:text-neutral-300 w-fit"
              href="https://lists.illinois.edu/lists/info/uiuc-fsae-rso"
              target="_blank"
              rel="noopener noreferrer"
            >
              <FiArrowUpRight className="size-[25px] absolute left-0 transition-transform duration-250" />
              <span className="pl-8 pr-0 transition-all duration-250">
                Mailing List
              </span>
            </a>
          </div>
